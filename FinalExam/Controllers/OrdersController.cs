...
namespace FinalExam.Controllers
{
    ...
    {
        private GroceryStoreContext db = new GroceryStoreContext();
        ...
        public ActionResult Create([Bind(Include = "OrderID,Date,CustomerID,EmployeeID")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderID,Date,CustomerID,EmployeeID")] Order order)
        {
            if (ModelState.IsValid)
            {
